    ...
    <form id="formReporte" class="space-y-4">
        ...
        <div>
            <div class="max-w-5xl mx-auto p-6 m-5 bg-white rounded-lg shadow-md">
                ...
                <select id="producto" name="producto" class="w-full p-2 border rounded-lg focus:ring focus:ring-blue-300">
    ...
    <x-slot name="thead">
        <thead class="text-white font-bold">
            <tr class="bg-slate-600">
                ...
                <th class="px-6 py-3 text-left font-medium uppercase tracking-wider">precio Anterior</th>
                <th class="px-6 py-3 text-left font-medium uppercase tracking-wider">precio Nuevo</th>
                <th class="px-6 py-3 text-left font-medium uppercase tracking-wider">fecha de Cambio</th>
            </tr>
        </thead>
    </x-slot>
...
<script>
   document.getElementById('btnGenerarInforme').addEventListener('click', async () => {
    ...
    let url = '/reporte-cambioPrecio/producto?';
