...
@section('contenido')
        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-3xl mb-10 p-5">
            <form action="{{ route('devoluciones.store') }}" method="POST">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-2 mb-5">
                        <label for="persona" class="uppercase block text-sm font-medium text-gray-900">persona</label>
    ...
    var $selectUsuario = document.getElementById('persona');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $selectSucursal.innerHTML = '<option value="">Seleccionar una sucursal</option>';
                            ...
                            var option = document.createElement('option');
                            option.value = data.sucursal.id;
                            option.textContent = data.sucursal.nombre;
