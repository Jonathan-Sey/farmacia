    ...
    <div class="mx-4 sm:mx-2 flex max-w-full sm:max-w-[640px] flex-wrap items-center justify-center">
        <form class="my-8 sm:my-20 mx-8 sm:mx-20 space-y-5 text-white" action="" >
                ...
                <div class="space-y-5 grid grid-cols-1 relative">
                    ...
                    <input type="text" placeholder="Contraseña" class="w-full sm:w-80 bg-[#FFFFFF30] px-10 py-2 rounded-full focus:bg-[#00000050] focus:outline-none focus:ring-2 focus:ring-cyan">
                </div>
            
                <button class="btn btn-outline font-bold left-[-50px] sm:left-5 w-80 text-white hover:bg-[#00000050] hover:text-white hover:border-white">Iniciar Secion</button>
        </form>
    </div>
    <div>
