            ...
            @csrf
                <div class="space-y-5 grid grid-cols-1 relative">
                    <div class="absolute top-6 left-[2px] items-center sm:items-center sm:justify-center justify-center bg-[#FFFFFF30] rounded-full px-2 py-1 ring-2 ring-cyan-500">
                        ...
                        <input id="email" type="email" name="email" placeholder="email" class="w-full sm:w-80 bg-[#FFFFFF30] px-11 py-2 rounded-full focus:bg-[#00000050] focus:outline-none focus:ring-2 focus:ring-cyan">
                    ...
                    <input id="password" type="password" name="password" placeholder="password" class="w-full sm:w-80 bg-[#FFFFFF30] px-10 py-2 rounded-full focus:bg-[#00000050] focus:outline-none focus:ring-2 focus:ring-cyan">
                </div>
